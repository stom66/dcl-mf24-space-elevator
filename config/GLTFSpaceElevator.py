...
op.filepath = 'C:\\projects\\dcl-mf24-space-elevator\\dcl-scene\\models\\space-elevator.gltf'
...
op.export_draco_mesh_compression_level = 10
...
op.export_morph_animation = False
